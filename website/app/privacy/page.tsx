...
export default function PrivacyPage() {
  return <main id="main-content">
    ...
    <section className="mode-section shell"><div className="mode-grid">
      ...
      <article className="mode-card mode-card--future"><span className="status-pill">Invitation beta</span><h2>Stored for your workspace</h2><p>Hosted workspaces use managed cloud infrastructure so explicitly authorized clients can connect remotely.</p><p>OAuth identity, tenant checks, review, export, disclosure logging, revocation, and workspace deletion are implemented. No security certification is claimed.</p></article>
    </div></section>
