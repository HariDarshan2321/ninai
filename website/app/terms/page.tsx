...
export const metadata: Metadata = {
  ...
  description: "Terms governing use of Ninai local software, hosted beta, and AI memory connectors.",
  alternates: { canonical: "/terms/" },
  openGraph: {
    title: "Ninai Terms of Service",
    description: "Terms for Ninai local software and the hosted beta.",
    url: "/terms/",
    ...
    <main id="main-content">
      <section className="page-hero page-hero--privacy">
        <div className="shell page-hero__grid">
          ...
          <div className="page-hero__aside"><p>These terms apply to the Ninai website, hosted beta, connectors, and downloadable local software.</p><span className="privacy-version">Effective 1 August 2026</span></div>
        </div>
      </section>
      ...
      <section className="privacy-sections shell">
        ...
        <article><span className="privacy-index">02</span><div><p className="section-label">The service</p><h2>Local software and hosted beta are separate modes.</h2><p>Local mode stores its vault on your device. Hosted mode stores an explicitly created cloud workspace so authorized AI clients can access approved memory. Features may change during the beta, and uninterrupted availability is not guaranteed.</p></div></article>
        <article><span className="privacy-index">03</span><div><p className="section-label">Your account and content</p><h2>You control what you submit.</h2><p>You are responsible for your account, connected clients, permissions, and content. You retain rights in your content and grant Ninai only the limited rights needed to host, process, secure, back up, and return it as requested. Do not submit content you lack permission to use.</p></div></article>
        <article><span className="privacy-index">04</span><div><p className="section-label">Acceptable use</p><h2>Do not misuse the service.</h2><ul><li>Do not store credentials, private keys, access tokens, unlawful content, or high-risk regulated data.</li><li>Do not probe, disrupt, overload, reverse engineer hosted protections, or access another workspace.</li><li>Do not use Ninai to violate another service&apos;s terms, intellectual-property rights, privacy, or law.</li></ul></div></article>
        ...
        <article><span className="privacy-index">07</span><div><p className="section-label">Suspension and deletion</p><h2>Access may be limited to protect users.</h2><p>We may suspend abusive, unlawful, insecure, or harmful use. You can revoke clients, export data, and delete a hosted workspace in the dashboard. Deletion and residual infrastructure copies are described in the <Link href="/privacy/">Privacy Policy</Link>.</p></div></article>
